...
/**
 * [Extiende de la clase Vehiculo, permite crear un camión]
 * 
...
public class Truck  extends Vehicle{
	...
	public String toString() {
		return "Bicicle // Id= " + getId() 
			 ...
			 + " // capacidad de carga(kg)= " + maximunLoad;
	}

	/**
	 * [Getter & Setters] 
	 */
	public float getMaximunLoad() {
		return maximunLoad;
	}

	public void setMaximunLoad(float maximunLoad) {
